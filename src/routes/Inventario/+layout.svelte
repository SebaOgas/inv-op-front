...
<div class="container-fluid">
    ...
    <button on:click={() => {redir("ModeloPorFamilias")}}>Determinar modelo de inventario</button>

    <button on:click={() => {redir("ProductosFaltantes")}}>Listado de productos faltantes</button>
